...
namespace GoogleAPI.Maps.Model.Geocoding {
    ...
    /// still returns an empty results array. (XML responses consist of 
    /// zero or more "result" elements.)
    /// </summary>
    [DataContract]
    public class Results {
        /// <summary>
        /// Is an array containing the separate address components.
        /// </summary>
        ...
        /// licensing restrictions.) This address is generally composed of one or more 
        /// address components. For example, the address "111 8th Avenue, New 
        ...
        /// though it did match part of the requested address. You may wish to examine the 
        /// original request for misspellings and/or an incomplete address. Partial matches 
        /// most often occur for street addresses that do not exist within the 
        /// locality you pass in the request.
        /// </summary>
        [DataMember(Name = "partial_match")]
        public bool PartialMatch { get; set; }
        /// <summary>
        /// Indicates the type of the returned result. This array contains a set of one 
        /// or more tags identifying the type of feature returned in the result. For 
        /// example, a geocode of "Chicago" returns "locality" which indicates that 
        /// "Chicago" is a city, and also returns "political" which indicates it is a 
        /// political entity.
        /// </summary>
        [DataMember(Name = "types")]
        public string[] GeoTypes { get; set; }
    }
}
